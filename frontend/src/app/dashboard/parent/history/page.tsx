...
export default function HistoryPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status.toLowerCase()) {
      ...
      case "pending":   return "bg-tertiary-container text-on-tertiary-container";
    ...
    <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
              ...
              <div className="flex flex-col lg:flex-row items-start gap-6">
                ...
                <div className="grow min-w-0">
                  <div className="flex flex-wrap items-center gap-3 mb-3">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-widest ${getStatusColor(record.status)}`}
                    >
                      {record.status}
                    </span>
                  </div>
        ...
        <div className="text-center py-20">
          ...
          <h3 className="font-headline font-bold text-2xl text-on-surface mb-4">No Sessions Found</h3>
