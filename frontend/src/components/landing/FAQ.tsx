...
const FAQS = [
  {
    q: "Is AutiSense AI a diagnostic tool?",
    a: "No. AutiSense AI flags developmental patterns and helps you prepare for a clinical conversation — it does not replace a formal diagnosis. All reports include prominent framing to make this clear and we never auto-route results to insurance or health records without your explicit consent.",
  },
  {
  ...
  {
    q: "What ages does AutiSense AI support?",
  ...
  },
  {
    ...
    a: "Yes — every report exports to a clinician-shareable PDF with the original signal timeline attached. You can also send a private link that expires in 7 days, or invite your doctor directly into your secure AutiSense AI account.",
  },
  {
...
export default function FAQ() {
  return (
    <section
      id="faq"
      className="relative bg-surface-container-low py-16 sm:py-20"
      data-tone="light"
    ...
    >
      <div className="mx-auto max-w-4xl px-6 sm:px-8 lg:px-10">
        ...
        <div className="rounded-3xl border border-outline-variant/15 bg-surface-container-lowest px-6 sm:px-8 shadow-card">
          {FAQS.map((f, i) => (
            <FaqItem key={f.q} q={f.q} a={f.a} idx={i} initialOpen={i === 0} />
          ))}
        </div>
      </div>
    </section>
