    ...
    <section className="mx-auto max-w-7xl space-y-4 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <GlassCard title="Try Screening">
          ...
          <Link href="/child-profile" className="mt-3 inline-block rounded-xl bg-sky-500 px-3 py-2 text-xs font-semibold text-white">Open Screening</Link>
        </GlassCard>
        <GlassCard title="Parent View">
          ...
          <Link href="/parent-dashboard" className="mt-3 inline-block rounded-xl bg-emerald-500 px-3 py-2 text-xs font-semibold text-white">Open Parent Dashboard</Link>
        </GlassCard>
        <GlassCard title="Doctor View">
          ...
          <Link href="/doctor-dashboard" className="mt-3 inline-block rounded-xl bg-indigo-500 px-3 py-2 text-xs font-semibold text-white">Open Doctor Dashboard</Link>
        </GlassCard>
        <GlassCard title="Create Account">
          <p className="text-sm text-slate-600 dark:text-slate-300">Switch to a real account anytime.</p>
          <Link href="/login?mode=register" className="mt-3 inline-block rounded-xl bg-slate-900 px-3 py-2 text-xs font-semibold text-white dark:bg-slate-100 dark:text-slate-900">Register</Link>
        </GlassCard>
      </div>
